...
- 2026-06-26: **A-3 완료** — `react-hooks/set-state-in-effect` warn→error 승격 + NbFrame을 `useSyncExternalStore` 기반 `useNbTheme` hook으로 분리. useNbTheme.test.ts 4 케이스. baseline 20→19.
